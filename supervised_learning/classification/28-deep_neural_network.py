#!/usr/bin/env python3
"""Defines a DeepNeuralNetwork class with multiple activation functions"""
...
class DeepNeuralNetwork:
    ...
    def __init__(self, nx, layers, activation='sig'):
        ...
        Args:
            ...
            activation (str): type of activation function for hidden
                layers ('sig' for sigmoid, 'tanh' for hyperbolic tangent)
        """
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        Args:
            ...
            graph: whether to graph training progress
            step: interval at which to print/graph
        """
